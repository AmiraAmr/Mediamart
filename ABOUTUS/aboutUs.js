...
$(".split .content .slide .indicators li").click(function() {
...
//    console.log(open);
    $(".split .content .slide .indicators li").removeClass("active");
    $(this).addClass("active");
    $(target + " .inner .item").removeClass("active");
    $(target + " .inner .item" + open).addClass("active");
})
