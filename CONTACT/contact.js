...
//navbar in sm&xs
$(".openMenu i").click(function() {
    $(this).fadeOut(200);
    $(".navbar").animate({right:"0"},400);
})
$(".navbar .closeMenu i").click(function() {
    $(".navbar").animate({right:"-250px"},400);
    $(".openMenu i").fadeIn(200);
})

//Thank You
$("form button.btn").click(function(e) {
    e.preventDefault();
    $(".split img").animate({left:"85%"},1500).fadeOut();
    $(".split img").animate({left:"-250px"},10).fadeIn();
})
